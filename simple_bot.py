...
async def send_welcome_message(bot, group_id):
    ...
    try:
        welcome_text = """
🏀 *ВЫХОДНОЙ БАСКЕТБОЛЬНЫЙ НАСТРОЙ!* 🏀

*💫 МОТИВИРУЮЩАЯ МЫСЛЬ:*
"Лучшие игроки знают - правильный отдых это 50% успеха в игре!"

*🎯 СОВЕТЫ ОТ БОТА НА ВЫХОДНЫЕ:*
• Сделайте легкую растяжку - ваше тело скажет "спасибо"
• Помечтайте о своем коронном броске
• Приготовьте спортивную форму на понедельник
• Настройтесь на новые баскетбольные свершения
...
Отличных выходных, команда! 
Отдыхайте, заряжайтесь и готовьтесь к новым победам на площадке! 🏀✨
        """
