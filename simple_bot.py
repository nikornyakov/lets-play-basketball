...
async def send_welcome_message(bot, group_id):
    ...
    try:
        welcome_text = """
Привет, команда! Ваш верный баскетбольный бот с ноябрьскими пожеланиями! 🏀

*🎯 МОТИВАЦИЯ НА НОЯБРЬ:*
"Ноябрь - не время для спячки! Это время для роста и подготовки к новым достижениям!"
...
*Для ноябрьского настроения:*
🍂 Насладитесь последними осенними деньками перед зимой!
☕ Согрейтесь горячими напитками - готовимся к "холодным" броскам!
🎯 Вспомните ноябрьские победы великих команд - заряжаемся историей!

*🔥 ИСТОРИЧЕСКАЯ СПРАВКА:*
Многие великие баскетбольные рекорды были установлены в ноябре!
Пусть эти выходные станут началом ваших личных рекордов!

Всем отличных выходных! 
Отдыхайте, заряжайтесь и готовьтесь к новым баскетбольным вершинам! 🏀✨
        """
