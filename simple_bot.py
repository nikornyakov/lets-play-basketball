...
async def send_welcome_message(bot, group_id):
    ...
    try:
        welcome_text = """
🏀 *СУББОТНИЙ ПРИВЕТ ОТ БАСКЕТБОЛЬНОГО БОТА!* 🏀

*🌟 МОТИВАЦИЯ ОТ БОТА:*
"Отдых - это не перерыв в тренировках, а их важная часть!"

*💪 СОВЕТЫ НА ВЫХОДНЫЕ:*
- Сделайте легкую растяжку утром
- Примите контрастный душ для тонуса
- Настройтесь на новые достижения!

*📅 РАСПИСАНИЕ ТРЕНИРОВОК НА СЛЕДУЮЩУЮ НЕДЕЛЮ:*

ВТОРНИК : 🏀 *19:00-20:30* Общая тренировка

ЧЕТВЕРГ : 🏀 *19:00-20:30* Тренировка команды

*📅 БУДЬТЕ В КУРСЕ:*
Команда Авито играет в турнире Шестового дивизиона НБЛ
🏀 ПЯТНИЦА: 31.10 22:10 *Авито vs МегаСтрой*

*📍 АДРЕС ЗАЛА:* "Basket Hall" 
ул. Салова, 57 корпус 5

*🍎 ПИТАНИЕ ЧЕМПИОНА:*
• Побалуйте себя вкусной и полезной едой
• Не забывайте про белок - строительный материал мышц
• Пейте много воды - гидратация прежде всего!
