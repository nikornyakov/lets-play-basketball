...
async def send_welcome_message(bot, group_id):
    ...
    try:
        welcome_text = """
*Субботний привет от вашего баскетбольного бота! 👋🏀*

*🎯 МОТИВАЦИЯ НА НЕДЕЛЮ:*
"Осень - не время для спячки! Это время для роста и совершенствования, как у наших российских клубов в Европе!"

*P.S.* Помните: даже в самую хмурую осеннюю погоду в нашем зале всегда светит солнце баскетбола! 
...
🏀 ВОСКРЕСЕНЬЕ 19.10 10:00 *Авито vs LayUp*

*📍 АДРЕС ЗАЛА:* "Basket Hall" 
ул. Салова, 57 корпус 5

*🌈 ПОЖЕЛАНИЯ НА ОСЕННИЕ ВЫХОДНЫЕ:*
🍁 Укрепите иммунитет - чтобы ни одна простуда не помешала тренировкам!
🧥 Оденьтесь потеплее - сохраняем форму для будущих матчей!
🚶 Прогуляйтесь в парке - дышим воздухом, как перед решающим броском!
